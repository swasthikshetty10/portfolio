...
export default function Home() {
    ...
    return (
        <div className={`h-[100vh]  flex flex-col-reverse  md:flex-row overflow-hidden `}>
            <div className="backgrop-blur-xl  z-10   pt-20 h-[50vh] sm:h-auto  text-center sm:text-start sm:pt-40 sm:pl-10 md:pl-20 md:pt-40 flex flex-col gap-10 md:gap-4   ">

                <Parallax speed={isXs || isSm || isMd ? -5 : - 5}>
                    <h1 className="text-5xl sm:text-7xl lg:text-8xl xl:text-8xl 2xl:text-9xl font-bold ">Hello, </h1>
                </Parallax>
                <Parallax speed={isXs || isSm || isMd ? -10 : -20}>
