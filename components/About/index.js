        ...
        <div className='text-center p-5 md:p-10    justify-center  items-center  bg-gradient-to-tr from-teal-50 via-sky-100 to-sky-50 dark:from-slate-900/95 dark:via-slate-900 dark:to-black    bg-gray-300  w-full'>
            ...
            <div className="text-start  md:text-lg  group space-y-6 md:space-y-8 md:p-10">
                <Fade  >
                    ...
                    md:group-hover:-translate-x-10 transform-color ease-liner delay-500 duration-500  p-5 md:p-10 rounded-xl max-w-screen-lg mx-auto backdrop-blur bg-slate-400/10 dark:bg-slate-800/10">
                        <div>
