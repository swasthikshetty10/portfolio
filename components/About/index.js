    ...
    return (
        <div className='text-center p-5 md:p-10   justify-center  items-center  bg-gradient-to-tr from-teal-50 via-sky-100 to-sky-50 dark:from-slate-900/95 dark:via-slate-900 dark:to-black    bg-gray-300  w-full'>
            ...
            <div className="text-start  group space-y-6 md:space-y-8 md:p-10">
                <Fade  >
                    <div className="
                    border-2 border-sky-600/50 hover:bg-gradient-to-l from-cyan-200/20 to-pink-100/20 dark:from-slate-900/10 dark:to-blue-900/10   ease-in-out  dark:border-slate-500/50
            
                    md:group-hover:-translate-x-10 transform ease-liner delay-500 duration-500  p-5 md:p-10 rounded-xl max-w-screen-lg mx-auto backdrop-blur bg-slate-400/10 dark:bg-slate-800/10">
                        <div>
