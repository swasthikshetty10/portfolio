            ...
            <form onSubmit={submitHandler} className="group p-2 justify-center items-center md:items-start gap-5 md:gap-10 lg:gap-14 flex flex-col md:flex-row md:p-10 mx-auto min-w-fit">
                ...
                <div className="flex-1  max-w-sm space-y-6 ">
                    <div>
                        ...
                        <input disabled={sending} className="w-full bg-slate-300/50 focus:border-2 border-opacity-50 border-sky-600 dark:border-slate-500 dark:bg-slate-300/10 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
